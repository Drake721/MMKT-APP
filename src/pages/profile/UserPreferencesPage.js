...
class UserPreferencesPage extends React.Component {
    ...
    render(){
        return <>
                ...
                <div className="my-3 p-3 bg-body rounded shadow-sm">
                    <h6 className="border-bottom pb-2 mb-0 mb-3">Configuración de notificaciones por Email</h6>
                        <div className="row">
                            <div className="col">
                                <div className="mb-3 form-check form-switch">
                                    ...
                                    <label className="form-check-label" htmlFor="disabledSwitchCheckChecked">
                                        <p>App updates <span className="text-gray-italic"> Reciba notificaciones cada vez que publiquemos una nueva actualización</span></p>
                                    </label>
                                </div>
                                <div className="mb-3 form-check form-switch">
                                    <input className="form-check-input" type="checkbox" role="switch" id="disabledSwitchCheckChecked"/>
                                    <label className="form-check-label" htmlFor="disabledSwitchCheckChecked">
                                        <p>Actualizacion de documentos <span className="text-gray-italic"> Reciba notificaciones cada vez que se edite un documento que sigues. </span></p>
                                    </label>
                                </div>
                                <hr/>
